...
var projectList = [
    ...
    flow_element: [
      {
        ...
        elementSrc: 'images/photo_gallery/snail.png',
        elementAlt: 'photo of snail community in a wooden box',
      },
      {
        elementClass: 'imagenes',
        elementSrc: 'images/photo_gallery/image_placeholder.png',
  ...
  },
  {
    ...
    flow_element: [
      {
        elementClass: 'imagenes',
        elementSrc: 'images/photo_gallery/wasteMgmt.JPG',
    ...
    pdf: [
      {
        title: 'Waste Management profile',
        link: 'https://www.sportencommun.org/wp-content/uploads/2020/08/aypad-profile.pdf',
      },
    ],
    event_information: {
  ...
  },
  {
    ...
    flow_element: [
      {
        elementClass: 'imagenes',
        elementSrc: 'images/photo_gallery/culture.png',
    ...
    pdf: [
      {
        title: 'Cultural Program profile',
        link: 'https://www.sportencommun.org/wp-content/uploads/2020/08/aypad-profile.pdf',
      },
    ],
    event_information: {
  ...
  },
  {
    ...
    flow_element: [
      {
        elementClass: 'imagenes',
        elementSrc: 'images/photo_gallery/edu.png',
  ...
  },
  {
    ...
    flow_element: [
      {
        elementClass: 'imagenes',
        elementSrc: 'images/photo_gallery/arts.png',
  ...
  },
  {
    ...
    flow_element: [
      {
        elementClass: 'imagenes',
        elementSrc: 'images/photo_gallery/tree.png',
  ...
  },
  {
    ...
    flow_element: [
      {
        elementClass: 'imagenes',
        elementSrc: 'images/photo_gallery/beautification.JPG',
        elementAlt:
  ...
  },
  {
    ...
    flow_element: [
      {
        elementClass: 'imagenes',
        elementSrc: 'images/photo_gallery/soccer.png',
        elementAlt: 'soccer team photo of young boy athletes before tournament',
      },
      {
        elementClass: 'imagenes',
        elementSrc: 'images/photo_gallery/soccerTeam.png',
        elementAlt:
  ...
  },
  {
    ...
    flow_element: [
      {
        elementClass: 'imagenes',
        elementSrc: 'images/photo_gallery/study.png',
    ...
    pdf: [
      {
        title: 'Skills Training Center profile',
        link: 'https://www.sportencommun.org/wp-content/uploads/2020/08/aypad-profile.pdf',
      },
    ],
    event_information: {
  ...
  },
  {
    ...
    flow_element: [
      {
        elementClass: 'imagenes',
        elementSrc: 'images/photo_gallery/children.png',
    ...
    pdf: [
      {
        title: 'Street Children Program profile',
        link: 'https://www.sportencommun.org/wp-content/uploads/2020/08/aypad-profile.pdf',
      },
    ],
    event_information: {
  ...
  },
  {
    ...
    flow_element: [
      {
        elementClass: 'imagenes',
        elementSrc: 'images/photo_gallery/hockey.png',
  ...
  },
  {
    ...
    flow_element: [
      {
        elementClass: 'imagenes',
        elementSrc: 'images/photo_gallery/microCredit.png',
  ...
  {
    id: 'youth_farming',
    cover: 'images/photo_gallery/henry-perks-aOTBPSDjgj0-unsplash-min.jpg',
    ...
    flow_element: [
      {
        elementClass: 'imagenes',
        elementSrc:
          'images/photo_gallery/henry-perks-aOTBPSDjgj0-unsplash-min.jpg',
  ...
  {
    id: 'fish_farming',
    cover: 'images/photo_gallery/uttam-kumar-roy-06GXlF9wE60-unsplash-min.jpg',
    caption: 'Fish Farming Project',
    banner: '',
    flow_element: [
      {
        elementClass: 'imagenes',
