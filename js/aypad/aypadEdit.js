var navigationArray = [
    { link_id: 'home', link_name: 'Home', link_href: '/index.html' },
    {
      link_id: 'about',
      link_name: 'About',
    ...
    { link_id: 'donate', link_name: 'Donate', link_href: './donate.html' },
  ],
  logoArray = [
    {
      link_href:
        'https://www.facebook.com/CommunityYouthNetworkProgramcynpInc/',
  ...
  brandArray = [
    ...
    {
      company_name:
        'Freya International Schools of Research and Implementation',
      company_add: [
